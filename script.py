...
for headline in news_headlines[:1]:
    data = {
...
# TODO: Create a file that maps the headlines to the image file names
...
# Create video with ffmpeg stitching together the images and lyrics. Put headlines onto images
